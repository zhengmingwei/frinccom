...
public final class SystemUtils {
    ...
    public static void main(String[] args) {
       ...
       // System.out.println(MacAddress.getMacAddress("10.2.2.71"));
        ...
        System.out.println(MacAddress.getMacInWindows("192.168.1.9"));
        System.out.println(MacAddress.getMacInWindows("192.168.1.6"));

        System.out.println(MacAddress.getMacInWindows("47.105.160.175"));
        System.out.println(MacAddress.getMacInLinux("47.105.123.55"));
    }
}
