 ...
 * 结合UUID生产算法hashcode;
 * <p>
 *     算法:两位年(2)+月份(2)+日(2)+uuid#hashCode(10);
 *     共16位
 *
 * @author zyj
 * @date 1/14/2015
 ...
 */
@Deprecated
public class OrderIDGenerator extends UUIDGenerator {

	public String prefixDateFormat = "yyMMdd";
	...
	public static void main(String[] args) {
		UUIDGenerator uuidGenerator = new OrderIDGenerator();
		for (int i = 0; i < 100; i++) {
