...
import {refreshUserList2, changeUserStatus, delUser} from 'actions/UserActions';
...
export default class UserList2 extends React.Component {
    ...
    render() {
        ...
        const pagination = {
            total: userList2.total,
            pageSize: userList2.pageSize,
            current: userList2.pageNum,
            onChange: (page) => {
                this.props.dispatch(refreshUserList2(userCriteria, {"pageNum": page}));
            },
        };
