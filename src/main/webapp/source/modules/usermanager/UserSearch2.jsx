...
import {refreshUserList2,userCriteriaChanged} from 'actions/UserActions';
 ...
 * Time: 上午10:26.
 */
class UserSearch2 extends React.Component {
    ...
    search(){
        ...
        this.props.dispatch( refreshUserList2(rows));
...
;
UserSearch2 = createForm()(UserSearch2);
