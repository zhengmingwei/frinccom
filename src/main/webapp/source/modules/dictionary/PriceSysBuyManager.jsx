...
import PriceSysBuyList from './PriceSysBuyList';
 ...
 * Time: 上午  10:30.  50
 */
class PriceSysBuyManager extends React.Component {
    constructor(props) {
        super(props);
    }
        ...
        return (
            <div>
                <SubPage breadcrumb="//订购套餐">
                    ...
                    <Row gutter={16}>
                        <Col>
                            <PriceSysBuyList {...this.props}  onEdit={this.edit} onView={this.view} onDelete={this.delete}/>
                        </Col>
                    </Row>
                </SubPage>
            </div>
